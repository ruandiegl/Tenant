        ...
        <div className="modal-backdrop" role="presentation" onMouseDown={closeProductModal}>
          <form className="modal-card product-modal" onMouseDown={(event) => event.stopPropagation()} onSubmit={handleProductSubmit} role="dialog" aria-modal="true" aria-label="Cadastro de produto">
            ...
            <div className="form-grid two-columns">
              ...
              <MoneyInput label="Preco base" required value={productDraft.basePrice} onChange={(basePrice) => setProductDraft({ ...productDraft, basePrice: basePrice ?? 0 })} />

              <MoneyInput
                label="Preco promocional"
                value={productDraft.promotionalPrice}
                onChange={(promotionalPrice) => setProductDraft({ ...productDraft, promotionalPrice })}
              />
            ...
            <ImageUploadField
              ...
              label="Imagem"
              pendingUpload={Boolean(productDraft.imageUpload)}
              onChange={(imageUrl, imageUpload) => setProductDraft({ ...productDraft, imageUrl, imageUpload })}
            />
