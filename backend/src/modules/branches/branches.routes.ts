...
import { createBranchSchema, deleteBranchSchema, updateBranchSchema } from "./branches.schemas.js";
...
branchesRoutes.delete("/:id", requirePermission("tenant.branches.write"), validate(deleteBranchSchema), controller.remove);
